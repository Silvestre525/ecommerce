...
class Suppliers(BaseModel):
    ...
    province = models.ForeignKey(Province, on_delete=models.CASCADE, related_name='suppliers')
    city = models.ForeignKey(City, on_delete=models.CASCADE, related_name='suppliers')
